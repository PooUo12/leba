...
/**
 * The managers.CollectionManager class is a singleton class that manages the collection of all the collections
 * in the application
 */
public class CollectionManager {
    ...
    public Route getByValue(Route routeToFind) {
        return routeCollection.stream().filter(route -> route.equals(routeToFind)).findFirst().orElse(null);
    }
    /**
